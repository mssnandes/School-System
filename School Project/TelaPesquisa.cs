...
namespace School_Project
{
    public partial class frmTelaPesquisa : Form
    {
        ...
        {
            frmTelaPesquisarAcessos menu = new frmTelaPesquisarAcessos();
            Visible = false;
            menu.ShowDialog();
            Visible = true;
        }
        ...
        {
            frmTelaPesquisarAlunos menu = new frmTelaPesquisarAlunos();
            Visible = false;
            menu.ShowDialog();
            Visible = true;
        }
        ...
        private void pcbBotaoPesquisaNotas_Click(object sender, EventArgs e)
        {
            frmTelaPesquisarNotasFrequencias menu = new frmTelaPesquisarNotasFrequencias();
            Visible = false;
            menu.ShowDialog();
            Visible = true;
        }
